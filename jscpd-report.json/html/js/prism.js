...
var Prism = (function (e) {
  ...
  var r = {
    ...
    util: {
      ...
      clone: function e(t, a) {
        ...
        switch (((a = a || {}), r.util.type(t))) {
          case 'Object':
            if (((s = r.util.objId(t)), a[s])) {
              return a[s];
            }
            for (const i in ((n = {}), (a[s] = n), t)) {
    ...
    languages: {
      ...
      txt: n,
      extend(e, t) {
        const a = r.util.clone(r.languages[e]);
        for (const n in t) {
          a[n] = t[n];
        }
        return a;
      },
      insertBefore(e, t, a, n) {
        const s = (n = n || r.languages)[e];
        const i = {};
        for (const l in s) {
      ...
      DFS: function e(t, a, n, s) {
        ...
        for (const l in t) {
          if (t.hasOwnProperty(l)) {
            a.call(t, l, t[l], n || l);
            const o = t[l];
            const u = r.util.type(o);
            u !== 'Object' || s[i(o)]
              ? u !== 'Array' || s[i(o)] || ((s[i(o)] = !0), e(o, a, l, s))
    ...
    highlightElement(a, n, s) {
      ...
      o &&
        ...
        (o.className = `${o.className.replace(t, '').replace(/\s+/g, ' ')} language-${i}`);
      const u = { element: a, language: i, grammar: l, code: a.textContent };
      function c(e) {
        ((u.highlightedCode = e),
      ...
      if ((r.hooks.run('before-highlight', u), u.grammar)) {
        ...
        c(r.util.encode(u.code));
      }
    },
    highlight(e, t, a) {
      const n = { code: e, grammar: t, language: a };
      return (
    ...
    for (const d in a) {
      if (a.hasOwnProperty(d) && a[d]) {
        ...
        for (let m = 0; m < p.length; ++m) {
          ...
          const h = p[m];
          const f = h.inside;
          const v = Boolean(h.lookbehind);
          const b = Boolean(h.greedy);
          const y = h.alias;
          ...
          for (
            ...
            if (!(P instanceof s)) {
              ...
              if (
                ...
                (l(e, t, a, x.prev, w, L), g && L.reach > g.reach && (g.reach = L.reach));
              }
            }
          }
        }
  ...
  if ((g && ((r.filename = g.src), g.hasAttribute('data-manual') && (r.manual = !0)), !r.manual)) {
    ...
    p === 'loading' || (p === 'interactive' && g && g.defer)
 ...
 */ (typeof module !== 'undefined' && module.exports && (module.exports = Prism),
  ...
  Object.defineProperty(Prism.languages.markup.tag, 'addInlined', {
    value(e, t) {
      ...
      ((a[`language-${t}`] = {
        ...
        (a.cdata = /^<!\[CDATA\[|\]\]>$/i));
      const n = { 'included-cdata': { pattern: /<!\[CDATA\[[\s\S]*?\]\]>/i, inside: a } };
  ...
  (function () {
    if (void 0 !== Prism && typeof document !== 'undefined') {
      ...
      const a = 'loading';
      const n = 'loaded';
      const r = 'pre[data-src]:not([data-src-status="loaded"]):not([data-src-status="loading"])';
      ...
      (Prism.hooks.add('before-highlightall', (e) => {
        ...
        Prism.hooks.add('before-sanity-check', (s) => {
          ...
          if (i.matches(r)) {
            ...
            let c = s.language;
            if (c === 'none') {
              const g = (/\.(\w+)$/.exec(u) || [, 'none'])[1];
              c = e[g] || g;
            }
            (l(o, c), l(i, c));
            const d = Prism.plugins.autoloader;
            d && d.loadLanguages(c);
        ...
        (Prism.plugins.fileHighlight = {
          highlight(e) {
            for (var t, a = (e || document).querySelectorAll(r), n = 0; (t = a[n++]); ) {
    ...
    function l(e, t) {
      let a = e.className;
      ((a = `${a.replace(s, ' ')} language-${t}`), (e.className = a.replace(/\s+/g, ' ').trim()));
    }
  })());
